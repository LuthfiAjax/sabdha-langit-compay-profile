...
<head>
    ...
    <meta name="keywords" content="Event organizer, EO, Grobogan, Purwodadi, Jawa Tengah, BUMN, EO Pemerintah daerah, pemda, Semarang">
    <meta name="description" content="Kami adalah perusahaan Event Organizer profesional di Grobogan, Jawa Tengah. Menawarkan layanan lengkap untuk acara pernikahan, acara bisnis, hingga Event Pemerintahan. Hubungi kami sekarang untuk mendapatkan solusi terbaik dan membuat acara Anda berkesan!">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="<?= base_url('assets/'); ?>images/logo/logo-panjang-hitam.png" alt="Logo Sabdha Langit" width="200" class="d-inline-block align-text-top">
                </a>
